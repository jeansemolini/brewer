...
public class Mailer {
	...
	@Async //sinaliza que é uma chamada assincrona não precisa esperar o retorno. Precisa configurar no WebCOnfig a anotação @EnableAsync
	public void enviar(Venda venda){
		...
		try {
			...
			helper.setFrom("jean.maiko@hotmail.com");
			//helper.setFrom("jean@conceptautomacao.com.br");
