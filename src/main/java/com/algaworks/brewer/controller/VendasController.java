...
public class VendasController {
	...
	@InitBinder("venda") //binder apenas para o atributo venda
	public void inicializarValidador(WebDataBinder binder){
		binder.setValidator(vendaValidator); //quando carregar o controller será inserido esse validador, quando a chamada tiver @Valid ele entrara em ação
	}
	...
	public ModelAndView exluirItem(@PathVariable("codigoCerveja")Cerveja cerveja, @PathVariable String uuid){ // precisa alterar o webConfig criando o domain pra funcionar assim
