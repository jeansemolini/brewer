...
public class EstilosController {
	...
	public @ResponseBody ResponseEntity<?> salvar(@RequestBody @Valid Estilo estilo, BindingResult result){ //@RequestBody para entender que é para converter o json para estilo 
		if (result.hasErrors()) {
