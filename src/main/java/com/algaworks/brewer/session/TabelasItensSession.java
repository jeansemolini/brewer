...
@SessionScope // um bean por padrão é unico para o sistema todo essa anotação cria um por sessão
@Component //para o spring entender e precisa colocar ela na WebConfig
public class TabelasItensSession {
	
	private Set<TabelaItensVenda> tabelas = new HashSet<>(); //pra cada sessão de usuario eu tenho varias tabelas
