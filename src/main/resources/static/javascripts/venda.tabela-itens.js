Brewer.TabelaItens = (function(){
	...
	function onDoubleClick(evento) {
		/* var item = $(evento.currentTarget); //quem chamou o evento (currenttarget) target é o obejto clicado
		item.toggleClass('solicitando-exclusao'); //se tiver a classe ele tira senao coloca 
		*/
		$(this).toggleClass('solicitando-exclusao'); //se tiver a classe ele tira senao coloca
	}
