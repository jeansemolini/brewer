...
Brewer.EstiloCadastroRapido = (function() {
	...
	function EstiloCadastroRapido(){
		...
		this.botaoSalvar = this.modal.find('.js-modal-cadastro-estilo-salvar-btn'); //procuro o botao a partir do modal
	...
	function onModalShow() {
		...
		this.inputNomeEstilo.attr('placeholder','Digite o nome do novo estilo');
	}
